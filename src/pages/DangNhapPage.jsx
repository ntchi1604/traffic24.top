    ...
    <div className="page-auth page-dangnhap">
      ...
      <section className="auth-section auth-section-center" aria-labelledby="dangnhap-heading">
        <div className="auth-panel auth-panel-solo">
          ...
          {/* Security badges */}
          <div className="auth-security-badges" aria-label="Bảo mật">
            <span className="auth-sec-badge">
              <svg width="11" height="11" viewBox="0 0 12 12" fill="none" style={{marginRight:4,verticalAlign:'middle'}}><rect x="1" y="4" width="10" height="7" rx="2" stroke="currentColor" strokeWidth="1.3"/><path d="M4 4V3a2 2 0 014 0v1" stroke="currentColor" strokeWidth="1.3" strokeLinecap="round"/></svg>
              SSL Encrypted
            </span>
            <span className="auth-sec-badge">
              <svg width="11" height="11" viewBox="0 0 12 12" fill="none" style={{marginRight:4,verticalAlign:'middle'}}><path d="M6 1L2 3v3c0 3 2 5 4 5s4-2 4-5V3L6 1z" stroke="currentColor" strokeWidth="1.3"/></svg>
              Bảo Mật 2FA
            </span>
            <span className="auth-sec-badge">
              <svg width="11" height="11" viewBox="0 0 12 12" fill="none" style={{marginRight:4,verticalAlign:'middle'}}><circle cx="6" cy="6" r="5" stroke="currentColor" strokeWidth="1.3"/><path d="M3.5 6l2 2 3-3" stroke="currentColor" strokeWidth="1.3" strokeLinecap="round" strokeLinejoin="round"/></svg>
              Xác Thực Đa Lớp
            </span>
          </div>
        </div>
